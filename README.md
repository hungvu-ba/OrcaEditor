...
This extension bundles several open-source libraries (mermaid, KaTeX, highlight.js, markdown-it, turndown, and their dependencies). See THIRD-PARTY-NOTICES.md for the full list and license texts.
